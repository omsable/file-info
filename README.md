# _File Info_ Open Microservice

> Detect file info, metadata, format, etc
...
| :------------ | :------- | :------- | :------ | :-------------------------- |
| url           | `string` | `true`   | None    | A URL to a file to inspect. |
...
[![Edit file-info on CodeSandbox](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/github/oms-services/file-info)
